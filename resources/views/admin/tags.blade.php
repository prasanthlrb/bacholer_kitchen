          ...
          <div class="card-body card-dashboard table-responsive">
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <tbody>
                ...
                <tr>
                  	<td>{{$key + 1}}</td>
                    <td>{{$row->tag_name_english}}</td>
                    <td>{{$row->tag_name_arabic}}</td>
            ...
            <div class="modal-body">
            	...
            	<input type="hidden" name="id" id="id">
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" id="tag_name_english" name="tag_name_english" class="form-control">
                    </div>

                    <div class="form-group">
                        <label>Tag Name Arabic</label>
                        <input autocomplete="off" type="text" id="tag_name_arabic" name="tag_name_arabic" class="form-control">
                    </div>
...
function Edit(id){
  $.ajax({
    ...
    success: function(data)
    {
        ...
        $('input[name=tag_name_english]').val(data.tag_name_english);
      	$('input[name=tag_name_arabic]').val(data.tag_name_arabic);
