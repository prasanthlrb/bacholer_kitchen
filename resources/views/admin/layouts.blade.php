    ...
    <div class="wrapper">
      ...
      <div data-active-color="white" data-background-color="man-of-steel" data-image="/app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
        ...
        <div class="sidebar-header">
          <div class="logo clearfix"><a href="/admin/dashboard" class="logo-text float-left">
              <div class="logo-img">
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
              ...
              <li class="menu-item has-sub nav-item">
                <a href="#">
                  <i class="ft-clipboard"></i>
                  <span data-i18n="" class="menu-title">Item</span>
                  <!-- <span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span> -->
                </a>
                <ul class="menu-content">
                  <li class="category">
                    <a href="/admin/category" class="menu-item">Add Category</a>
                  </li>
                  <li class="tags">
                    <a href="/admin/tags" class="menu-item">Add tags</a>
                  </li>
                  <li class="item">
                    <a href="/admin/item" class="menu-item">Add Item</a>
                  </li>
                  <li class="food-package">
                    <a href="/admin/food-package" class="menu-item">Add Package</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="booking nav-item">
              	<a href="/admin/booking-details">
              		<i class="ft-credit-card"></i>
              		<span data-i18n="" class="menu-title">Booking Details</span>
              	</a>
              </li>
              ...
              <li class="chat-to-customer nav-item">
                <a href="/admin/chat-to-customer">
                  ...
                  <span data-i18n="" class="menu-title">Chat to Customer</span>
                </a>
              </li>

              <!-- <li class="delivery-time nav-item">
                <a href="#">
                  <i class="ft-calendar"></i>
                  <span data-i18n="" class="menu-title">Delivery Time</span>
                </a>
              </li> -->

              <!-- <li class="master has-sub nav-item">
                <a href="#">
                  <i class="ft-home"></i>
                ...
                <ul class="menu-content">
                  <li class="home-slider">
                    <a href="/admin/slider" class="menu-item">Home Slider</a>
                  </li>
                  <li class="ad-slider">
                    <a href="/admin/ad-slider" class="menu-item">Ad Slider</a>
                  </li>
                  <li class="vehicle-type">
                    <a href="/admin/vehicle-type" class="menu-item">Types of Vehicles</a>
                  </li>
                </ul>
              </li> -->
              ...
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                  ...
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right">
                    <a href="/admin/edit-profile" class="dropdown-item py-1">
      ...
      <div class="main-panel">
        ...
        <footer class="footer footer-static footer-light">
          <p class="clearfix text-muted text-sm-center px-2"><span>Copyright  &copy; {{date('Y')}} <a href="https://lrbinfotech.com" id="lrbinfotech" target="_blank" class="text-bold-800 primary darken-2">LRB INFO TECH </a>, All rights reserved. </span></p>
        </footer>
        <!-- End : Footer-->
