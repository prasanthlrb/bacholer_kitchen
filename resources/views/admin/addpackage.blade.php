            ...
            <input type="hidden" name="id" id="id">
              ...
              <div class="form-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                        <div id="preview"><img id="prevImage" style="width:120px;padding-top:20px;" src="" /></div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <div class="custom-checkbox custom-control-inline ml-3">
                            <input value="1" type="checkbox" id="breakfast_enable" name="breakfast_enable" class="custom-control-input">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <div class="custom-checkbox custom-control-inline ml-3">
                            <input value="1" type="checkbox" id="lunch_enable" name="lunch_enable" class="custom-control-input">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <div class="custom-checkbox custom-control-inline ml-3">
                            <input value="1" type="checkbox" id="dinner_enable" name="dinner_enable" class="custom-control-input">
...
<div id="breakfast_show">
    <div class="form-group">
        ...
        <input autocomplete="off" type="text" id="breakfast_price" name="breakfast_price" class="form-control">
    </div>
...
<div id="lunch_show">
    <div class="form-group">
        ...
        <input autocomplete="off" type="text" id="lunch_price" name="lunch_price" class="form-control">
    </div>
...
<div id="dinner_show">
    <div class="form-group">
        ...
        <input autocomplete="off" type="text" id="dinner_price" name="dinner_price" class="form-control">
    </div>
