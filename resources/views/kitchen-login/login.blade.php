...
<html lang="en" class="loading">
  <!-- BEGIN : Head-->
  <head>
    <title>Kitchen Login Bachelor Kitchen</title>
            ...
            <div class="card-body login-img">
              ...
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  <h4 class="mb-2 card-title">Kitchen Login</h4>
                  <p class="card-text mb-3">
                    Welcome back, please login to your account.
                  </p>
                    <input class="form-control mb-3 @error('email') is-invalid @enderror" id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email address">
                    @error('email')
                  ...
                  <div class="d-flex justify-content-between mt-2">
                    ...
                    <div class="forgot-password-option">
                      <a href="{{ route('kitchen.password.request') }}" class="text-decoration-none text-primary">Forgot Password?</a>
                    </div>
                  </div>
